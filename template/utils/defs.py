...
mf_color_schemas = {
    "instrument_control_0": [
        [1, colors_by_name["Kick"]["default"], 40, 40],
        [5, colors_by_name["Kick"]["default"], 40, 40],
        [9, colors_by_name["Kick"]["default"], 40, 40],
        [13, colors_by_name["Kick"]["default"], 40, 40],

        [2, colors_by_name["Minitaur"]["default"], 40, 40],
        [6, colors_by_name["Minitaur"]["default"], 40, 40],
        [10, colors_by_name["Minitaur"]["default"], 40, 40],
        [14, colors_by_name["Minitaur"]["default"], 40, 40],

        [3,  colors_by_name["Drums"]["default"], 40, 40],
        [7,  colors_by_name["Drums"]["default"], 40, 40],
        [11, colors_by_name["Drums"]["default"] , 40, 40],
        [15,  colors_by_name["Drums"]["default"], 40, 40],

        [4, colors_by_name["Omni 4"]["default"], 40, 40],
        [8, colors_by_name["Omni 4"]["default"], 40, 40],
        [12, colors_by_name["Omni 4"]["default"], 40, 40],
        [16, colors_by_name["Omni 4"]["default"], 40, 40],

        [17, colors_by_name["Kick"]["default"], 40, 40],
        [18, colors_by_name["Minitaur"]["default"], 40, 40],
        [19, colors_by_name["Drums"]["default"], 40, 40],
        [20, colors_by_name["Omni 4"]["default"], 40, 40],


    ],

    "instrument_control_1": [
        [1, colors_by_name["Omni 1"]["default"], 40, 40],
        [5, colors_by_name["Omni 1"]["default"], 40, 40],
        [9, colors_by_name["Omni 1"]["default"], 40, 40],
        [13, colors_by_name["Omni 1"]["default"], 40, 40],

        [2, colors_by_name["V. Bass"]["default"], 40, 40],
        [6, colors_by_name["V. Bass"]["default"], 40, 40],
        [10, colors_by_name["V. Bass"]["default"], 40, 40],
        [14, colors_by_name["V. Bass"]["default"], 40, 40],

        [3, colors_by_name["SH01A"]["default"], 40, 40],
        [7, colors_by_name["SH01A"]["default"], 40, 40],
        [11, colors_by_name["SH01A"]["default"], 40, 40],
        [15, colors_by_name["SH01A"]["default"], 40, 40],

        [4, colors_by_name["TB3"]["default"], 40, 40],
        [8, colors_by_name["TB3"]["default"], 40, 40],
        [12, colors_by_name["TB3"]["default"], 40, 40],
        [16, colors_by_name["TB3"]["default"], 40, 40],

        [17, colors_by_name["Omni 1"]["default"], 40, 40],
        [18, colors_by_name["V. Bass"]["default"], 40, 40],
        [19, colors_by_name["SH01A"]["default"], 40, 40],
        [20, colors_by_name["TB3"]["default"], 40, 40],

    ],
    "instrument_control_2": [
        [1, colors_by_name["Grandmother"]["default"], 40, 40],
        [5, colors_by_name["Grandmother"]["default"], 40, 40],
        [9, colors_by_name["Grandmother"]["default"], 40, 40],
        [13, colors_by_name["Grandmother"]["default"], 40, 40],

        [2, colors_by_name["Deepmind"]["default"], 40, 40],
        [6, colors_by_name["Deepmind"]["default"], 40, 40],
        [10, colors_by_name["Deepmind"]["default"], 40, 40],
        [14, colors_by_name["Deepmind"]["default"], 40, 40],

        [3, colors_by_name["Omni 2"]["default"], 40, 40],
        [7, colors_by_name["Omni 2"]["default"], 40, 40],
        [11, colors_by_name["Omni 2"]["default"], 40, 40],
        [15, colors_by_name["Omni 2"]["default"], 40, 40],

        [4, colors_by_name["GTR VOX"]["default"], 40, 40],
        [8, colors_by_name["GTR VOX"]["default"], 40, 40],
        [12, colors_by_name["GTR VOX"]["default"], 40, 40],
        [16, colors_by_name["GTR VOX"]["default"], 40, 40],

        [17, colors_by_name["Grandmother"]["default"], 40, 40],
        [18, colors_by_name["Deepmind"]["default"], 40, 40],
        [19, colors_by_name["Omni 2"]["default"], 40, 40],
        [20, colors_by_name["GTR VOX"]["default"], 40, 40],
    ],
    "instrument_control_3": [
        [1, colors_by_name["BASS COMP"]["default"], 40, 40],
        [5, colors_by_name["BASS COMP"]["default"], 40, 40],
        [9, colors_by_name["BASS COMP"]["default"], 40, 40],
        [13, colors_by_name["BASS COMP"]["default"], 40, 40],

        [2, colors_by_name["Yamaha"]["default"], 40, 40],
        [6, colors_by_name["Yamaha"]["default"], 40, 40],
        [10, colors_by_name["Yamaha"]["default"], 40, 40],
        [14, colors_by_name["Yamaha"]["default"], 40, 40],

        [3, colors_by_name["Omni 3"]["default"], 40, 40],
        [7, colors_by_name["Omni 3"]["default"], 40, 40],
        [11, colors_by_name["Omni 3"]["default"], 40, 40],
        [15, colors_by_name["Omni 3"]["default"], 40, 40],

        [4, colors_by_name["GTR Acus"]["default"], 40, 40],
        [8, colors_by_name["GTR Acus"]["default"], 40, 40],
        [12, colors_by_name["GTR Acus"]["default"], 40, 40],
        [16, colors_by_name["GTR Acus"]["default"], 40, 40],

        [17, colors_by_name["BASS COMP"]["default"], 40, 40],
        [18, colors_by_name["Yamaha"]["default"], 40, 40],
        [19, colors_by_name["Omni 3"]["default"], 40, 40],
        [20, colors_by_name["GTR Acus"]["default"], 40, 40],
    ],
    "master_fx_and_sends": [
        [1, colors_by_name["A-Send A"]["default"], 40, 40],
        [2, colors_by_name["A-Send A"]["default"], 40, 40],
        [5, colors_by_name["A-Send A"]["default"], 40, 40],
        [6, colors_by_name["A-Send A"]["default"], 40, 40],

        [9, colors_by_name["C-Send C"]["default"], 40, 40],
        [10, colors_by_name["C-Send C"]["default"], 40, 40],
        [11, colors_by_name["C-Send C"]["default"], 40, 40],
        [12, colors_by_name["C-Send C"]["default"], 40, 40],

        [13, colors_by_name["Master"]["default"], 40, 40],
        [14, colors_by_name["Master"]["default"], 40, 40],
        [15, colors_by_name["Master"]["default"], 40, 40],
        [16, colors_by_name["Master"]["default"], 40, 40],

        [3, colors_by_name["B-Send B"]["default"], 40, 40],
        [4, colors_by_name["B-Send B"]["default"], 40, 40],
        [7, colors_by_name["B-Send B"]["default"], 40, 40],
        [8, colors_by_name["B-Send B"]["default"], 40, 40],
    ],
    "live_1": [
        [1, colors_by_name["Drums"]["default"], 40, 40],
        [5, colors_by_name["Drums"]["default"], 40, 40],
        [9, colors_by_name["Drums"]["default"], 40, 40],
        [13, colors_by_name["Drums"]["default"], 40, 40],
        ...
        [3, colors_by_name["Omni 1"]["default"], 40, 40],
        [7, colors_by_name["Omni 1"]["default"], 40, 40],
        [11, colors_by_name["Omni 1"]["default"], 40, 40],
        [15, colors_by_name["Omni 1"]["default"], 40, 40],
        ...
        [17, colors_by_name["Drums"]["default"], 40, 40],
        [18, colors_by_name["Yamaha"]["default"], 40, 40],
        [19, colors_by_name["Omni 1"]["default"], 40, 40],
        [20, colors_by_name["GTR VOX"]["default"], 40, 40],
    ],
}
