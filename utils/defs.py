...
mf_color_schemas = {
    ...
    "master_fx_and_sends": [
        [1, colors_by_name["A-Send A"]["default"], 15, 15],
        [2, colors_by_name["A-Send A"]["default"], 15, 15],
        [5, colors_by_name["A-Send A"]["default"], 15, 15],
        [6, colors_by_name["A-Send A"]["default"], 15, 15],

        [9, colors_by_name["C-Send C"]["default"], 15, 15],
        [10, colors_by_name["C-Send C"]["default"], 15, 15],
        [11, colors_by_name["C-Send C"]["default"], 15, 15],
        [12, colors_by_name["C-Send C"]["default"], 15, 15],

        [13, colors_by_name["Master"]["default"], 15, 15],
        [14, colors_by_name["Master"]["default"], 15, 15],
        [15, colors_by_name["Master"]["default"], 15, 15],
        [16, colors_by_name["Master"]["default"], 15, 15],

        [3, colors_by_name["B-Send B"]["default"], 15, 15],
        [4, colors_by_name["B-Send B"]["default"], 15, 15],
        [7, colors_by_name["B-Send B"]["default"], 15, 15],
        [8, colors_by_name["B-Send B"]["default"], 15, 15],
    ],
    "live_1": [
