...
master_fx_and_sends = """ 
    ...
    bind mf_b1_e5 "A-Send A"/DEV(2) P2;
    bind mf_b1_e9 "A-Send A"/DEV(2) P3;
    bind mf_b1_e13 "A-Send A"/DEV(2) P4;

    bind mf_b1_e2 "B-Send B"/DEV(2) P1;
    bind mf_b1_e6 "B-Send B"/DEV(2) P2;
    bind mf_b1_e10 "B-Send B"/DEV(2) P3;
    bind mf_b1_e14 "B-Send B"/DEV(2) P4;

    bind mf_b1_e3 "C-Send C"/DEV(2) P1;
    bind mf_b1_e7 "C-Send C"/DEV(2) P2;
    bind mf_b1_e11 "C-Send C"/DEV(2) P3;
    bind mf_b1_e15 "C-Send C"/DEV(2) P4;

    bind mf_b1_e4 "Master"/DEV(2) P1;
    bind mf_b1_e8 "Master"/DEV(2) P2;
    bind mf_b1_e12 "Master"/DEV(2) P3;
